...
class caloriecalc extends Component {
  ...
  constructor(props) {
     super(props);
     this.state = { name: 'Guest', weight: 90, height: 180, age:18,bmr:'x', message: '',optimalweight: '', activity: 'Sedentary',time: new Date().toLocaleTimeString() };
  ...
  //  if (find("Sedentary").checked)
    ...
    //else if(find("Light Activity").checked)
      //  cal = 1.375*bmr;
    else if (this.state.activity === "Light Activity")
          cal = 1.375*bmr
    else if (this.state.activity === "Moderate Activity")
        cal = 1.55*bmr
    else
        cal = 1.725*bmr
      ...
      <div className="App">
        <div className="App-header">
          ...
          <form onSubmit={this.submitMe}>
            ...
            <br/>
            <select value={this.state.activity} onChange={this.activitychange}>
